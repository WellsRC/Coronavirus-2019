...
mincfw=1.025020048115477; % median increase in flight weight (based on routes) among all 63 countries outside of china
...
% Save controu map
save('Weighted_RouteTravel_Infectious_6733.mat','MLE','w');